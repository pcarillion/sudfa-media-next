...
//   try {
//     // Note: Payload handles media serving automatically via built-in routes at /api/media/*
//     // This custom route is no longer needed with Payload CMS
//     return NextResponse.json(
//       { error: "Media serving handled by Payload at /media/*" },
//       { status: 404 }
//     );
